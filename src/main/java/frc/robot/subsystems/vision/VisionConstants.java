...
public final class VisionConstants {
    ...
    public static final double LINEAR_STD_DEV_BASELINE = 0.05;
    ...
    public static final double MAX_VISION_TRANSLATION_DELTA_METERS = 3.0;
    public static final double MAX_VISION_HEADING_DELTA_DEGREES = 35.0;
    public static final double MAX_CONSENSUS_TRANSLATION_DELTA_METERS = 1.0;
    public static final double MAX_CONSENSUS_HEADING_DELTA_DEGREES = 20.0;
    ...
    public static final double RAW_POSE_MAX_AGE_SECONDS = 0.25;
    public static final double CONSENSUS_POSE_MAX_AGE_SECONDS = 0.5;
